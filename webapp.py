...
def show_teams_name():
    data1 = requests.get("http://127.0.0.1:5000/").json()
...
def main():
    ...
    with tab2:
        ...
        if enter1:
            response = requests.get(f"http://127.0.0.1:5000/api/teamvteam?team1={i}&team2={j}").json()
    ...
    with tab3:
        ...
        if enter:
            response3 = requests.get(f"http://127.0.0.1:5000/api/team-record?team={i3}").json()
    ...
    with tab4:
        ...
        if enter:
            response4 = requests.get(f"http://127.0.0.1:5000/api/team-record?team={i4}").json()
    ...
    with tab5:
        ...
        if enter:
            response6 = requests.get(f"http://127.0.0.1:5000/api/batsman-record?batsman={i5}").json()
